...
LORA_PATH = "./autodl-tmp/output/Qwen3-1.7B/lora-sft/final_adapter"
DORA_PATH = "./autodl-tmp/output/Qwen3-1.7B/dora-sft/final_adapter"
...
def main():
    ...
    configs = [("Base", None)]
    #configs = [("Base", None), ("LoRA", LORA_PATH), ("DoRA", DORA_PATH)]
    summary = []
